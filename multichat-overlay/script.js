...
const showTwitchMessages = GetBooleanParam("showTwitchMessages", false);
...
const showTikTokLikes = GetBooleanParam("showTikTokLikes", true);
...
const showTikTokShare = GetBooleanParam("showTikTokShare", true);
